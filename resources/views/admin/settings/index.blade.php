...
{{--                                            </div>--}}
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <label for="markup[products_description]">Описание продуктов</label>
                                                    <textarea id="markup[products_description]" class="form-control summernote" name="markup[products_description]">{{ $setting->markup->products_description ?? ''}}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">
